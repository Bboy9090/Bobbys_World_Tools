...
- Automatic snapshots referenced in architecture but backend API pending
...
- Plugin installation/uninstallation needs real backend implementation

**Critical Issue:** Plugin system is currently frontend-only. Must implement backend API.
